...
class RegisterIO implements IIOProvider {
	...
	if (io_provider.read(first_address, curr_data)) {
	    ...
	    board_state.sensor_status = AHRSProtocol.decodeBinaryUint16(curr_data,
    ...
    @Override
    public void zeroYaw() {
	io_provider.write(IMURegisters.NAVX_REG_INTEGRATION_CTL, AHRSProtocol.NAVX_INTEGRATION_CTL_RESET_YAW);
	this.notify_sink.yawResetComplete();
    }

    @Override
    public void zeroDisplacement() {
	io_provider.write(IMURegisters.NAVX_REG_INTEGRATION_CTL, (byte) (AHRSProtocol.NAVX_INTEGRATION_CTL_RESET_DISP_X

...
class RegisterIO_SPI implements IRegisterIO {
	...
	if (trace)
	    System.out.println("navX-MXP:  Initialized SPI communication at bitrate " + bitrate);
	return true;
    }
	...
	if (!write_ok) {
	    if (trace)
		System.out.println("navX-MXP SPI Read:  Write error");

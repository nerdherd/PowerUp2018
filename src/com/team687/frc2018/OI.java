...
public class OI {
	...
	public OI() {
		...
		SmartDashboard.putData("Arm Position Down", new SetArmPosition(SuperstructureConstants.kArmDownPos));
		...
		SmartDashboard.putData("Wrist Position Score Forward Position",
				new SetWristPosition(SuperstructureConstants.kWristScoreForwardsScalePos));
		SmartDashboard.putData("Wrist Position Score Backward Position",
				new SetWristPosition(SuperstructureConstants.kWristScoreBackwardsScalePos));
		//

 ...
 *
 */
public class SideToSameSideScaleRight extends CommandGroup {

    public SideToSameSideScaleRight() {
...
//        addParallel(new BackwardsScaleToStow());
    	addSequential(new DriveBezierPath(AutoConstants.kRedRightSameSideScalePath, -0.5, .00811, .00118, true));

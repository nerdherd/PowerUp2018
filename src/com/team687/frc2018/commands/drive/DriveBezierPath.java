...
public class DriveBezierPath extends Command {
	...
	if (m_counter < m_arcLengthList.size()) {
		...
		SmartDashboard.putNumber("left Pow", leftPow);
		SmartDashboard.putNumber("right Pow", rightPow);
		SmartDashboard.putNumber("Straight Pow", straightPower);
		SmartDashboard.putNumber("Rotational Pow", rotPower);
	    } else {
		m_counter++;
	    }
	} else {

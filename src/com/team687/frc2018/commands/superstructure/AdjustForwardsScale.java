...
public class AdjustForwardsScale extends Command {
    ...
    protected void execute() {
    	...
    	else if (m_armPosition == SuperstructureConstants.kArmLowScalePosition) {
    		Robot.wrist.setAngleAbsolute(40);
    	} 
    	else if (m_armPosition == SuperstructureConstants.kArmLowerScalePosition) {
    		Robot.wrist.setAngleAbsolute(70);
    	} 
    	else if (m_armPosition >= SuperstructureConstants.kArmWristSafePos) {
    		Robot.wrist.setAngleAbsolute(10);
    	} 
    	else {
